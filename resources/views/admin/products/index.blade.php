            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="container px-5 py-24 mx-auto">
                        <form class="mb-8" method="get" action="{{ route('admin.products.index') }}">
                        ...
                        <div class="py-8 md:flex">
                            ...
                            <span class="mt-1 text-gray-500 text-sm">{{ $product->created_at }}</span>
                            </div>
                            ...
                            <a href="{{ route('admin.products.show', ['product' => $product->id]) }}" class="text-indigo-500 inline-flex items-center absolute bottom-0">詳細を見る
